...
export const kinds = {
  ...
  diamondsword: [Types.Entities.DIAMONDSWORD, "weapon", "Diamond Sword", 44, 36],
  minotauraxe: [Types.Entities.MINOTAURAXE, "weapon", "Minotaur Axe", 46, 38],
  ...
  emeraldarmor: [Types.Entities.EMERALDARMOR, "armor", "Emerald Armor", 40, 52],
  templararmor: [Types.Entities.TEMPLARARMOR, "armor", "Templar Armor", 40, 54],
  dragonarmor: [Types.Entities.DRAGONARMOR, "armor", "Dragon Armor", 40, 54],
  demonarmor: [Types.Entities.DEMONARMOR, "armor", "Demon Armor", 40, 56],
  mysticalarmor: [Types.Entities.MYSTICALARMOR, "armor", "Mystical Armor", 40, 58],
  bloodarmor: [Types.Entities.BLOODARMOR, "armor", "Blood Armor", 40, 62],
  paladinarmor: [Types.Entities.PALADINARMOR, "armor", "Paladin Armor", 40, 62],
  ...
  beltemerald: [Types.Entities.BELTEMERALD, "belt", "Emerald Belt", 40, 24],
  beltexecutioner: [Types.Entities.BELTEXECUTIONER, "belt", "Executioner Belt", 40, 26],
  belttemplar: [Types.Entities.BELTTEMPLAR, "belt", "Templar Belt", 40, 26],
  beltdemon: [Types.Entities.BELTDEMON, "belt", "Demon Belt", 40, 26],
  beltmystical: [Types.Entities.BELTMYSTICAL, "belt", "Mystical Belt", 40, 28],
  beltmoon: [Types.Entities.BELTMOON, "belt", "Moon Belt", 40, 28],
  ...
  shieldemerald: [Types.Entities.SHIELDEMERALD, "shield", "Emerald Shield", 40, 26],
  shieldexecutioner: [Types.Entities.SHIELDEXECUTIONER, "shield", "Executioner Shield", 40, 26],
  shieldtemplar: [Types.Entities.SHIELDTEMPLAR, "shield", "Templar Shield", 40, 28],
  shielddragon: [Types.Entities.SHIELDDRAGON, "shield", "Dragon Shield", 40, 28],
  shielddemon: [Types.Entities.SHIELDDEMON, "shield", "Demon Shield", 40, 30],
  shieldmystical: [Types.Entities.SHIELDMYSTICAL, "shield", "Mystical Shield", 40, 32],
  shieldmoon: [Types.Entities.SHIELDMOON, "shield", "Moon Shield", 40, 32],
...
Types.itemUniqueMap = {
  ...
  frozensword: ["Broccolish Fury", 28, 32],
  diamondsword: ["Inevitable", 46, 42],
  minotauraxe: ["PoS4QoS", 48, 44],
  emeraldsword: ["Non Fungible Token", 50, 60],
  executionersword: ["The Granfather", 52, 60],
  templarsword: ["TBD", 54, 62],
  ...
  emeraldarmor: ["Jungle Warcry", 36, 56],
  templararmor: ["133 Club", 36, 58],
  dragonarmor: ["BlackRock", 36, 58],
  demonarmor: ["Explorer's Block", 36, 60],
  mysticalarmor: ["Rug Pull", 36, 60],
  bloodarmor: ["TBD", 36, 64],
  paladinarmor: ["TBD", 36, 64],
  ...
  shieldemerald: ["PermaBear", 42, 30],
  shieldexecutioner: ["Clownbase", 42, 30],
  shieldtemplar: ["NanoStrategy", 42, 32],
  shielddragon: ["SEC Crackdown", 42, 32],
  shielddemon: ["ORV > POW", 42, 34],
  shieldmystical: ["TBD", 42, 36],
  shieldmoon: ["TBD", 42, 36],
  ...
  beltemerald: ["CBDC", 40, 28],
  beltexecutioner: ["TBD", 40, 30],
  belttemplar: ["TBD", 40, 30],
  beltdemon: ["TBD", 40, 32],
  beltmystical: ["TBD", 40, 34],
  beltmoon: ["TBD", 40, 34],
};
