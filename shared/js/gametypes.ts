...
export const kinds = {
  ...
  shieldemerald: [Types.Entities.SHIELDEMERALD, "shield", "Emerald Shield", 50, 28],
  shieldexecutioner: [Types.Entities.SHIELDEXECUTIONER, "shield", "Executioner Shield", 50, 28],
  shieldtemplar: [Types.Entities.SHIELDTEMPLAR, "shield", "Templar Shield", 52, 30],
  shielddragon: [Types.Entities.SHIELDDRAGON, "shield", "Dragon Shield", 52, 30],
  shielddemon: [Types.Entities.SHIELDDEMON, "shield", "Demon Shield", 54, 34],
  shieldmystical: [Types.Entities.SHIELDMYSTICAL, "shield", "Mystical Shield", 54, 34],
  shieldmoon: [Types.Entities.SHIELDMOON, "shield", "Moon Shield", 54, 34],
...
Types.itemUniqueMap = {
  ...
  shieldemerald: ["PermaBear", 54, 32],
  shieldexecutioner: ["Clownbase", 54, 32],
  shieldtemplar: ["NanoStrategy", 56, 34],
  shielddragon: ["SEC Crackdown", 56, 34],
  shielddemon: ["ORV > POW", 58, 36],
  shieldmoon: ["TBD", 58, 38],
  shieldmystical: ["TBD", 58, 38],
