...
import minotauraxe from "../sprites/weapon-large.json";
...
const sprites = {
  ...
  "pet_monkey-1": pet_cat,
  "pet_hellhound-1": pet_cat,
  ...
  "item-gold-3": item,
  "item-nanocoin": item,
  "item-bananocoin": item,
  "item-barbronze": item,
  "item-barsilver": item,
  "item-bargold": item,
  "item-barplatinum": item,
  ...
  "item-ringgreed": item,
  "item-ringimmortal": item,
  "item-ringpaladin": item,
  ...
  "item-amuleteye": item,
  "item-amuletgreed": item,
  "item-amuletimmortal": item,
  "item-amuletpaladin": item,
  "item-chestblue": item,
  ...
  "item-scrolltransmutepet": item,
  "item-scrollupgradeelementmagic": item,
  "item-scrollupgradeelementflame": item,
  "item-scrollupgradeelementlightning": item,
  "item-scrollupgradeelementcold": item,
  "item-scrollupgradeelementpoison": item,
  "item-scrollupgradeskillrandom": item,
  ...
  "item-drawAdminBadge": item,
  "item-petturtle": item,
  "item-petduck": item,
  "item-petdeer": item,
  "item-petreindeer": item,
  "item-petmonkey": item,
  "item-pethellhound": item,
  "item-petdragon": item,
  "item-petmouse": item,
