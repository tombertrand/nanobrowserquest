...
import spikearmor from "../sprites/armor.json";
...
import itemBluesword from "../sprites/item.json";
import itemBurger from "../sprites/item.json";
import itemCake from "../sprites/item.json";
import itemFirefoxpotion from "../sprites/item.json";
import itemFlask from "../sprites/item.json";
import itemRejuvenationpotion from "../sprites/item.json";
import itemPoisonpotion from "../sprites/item.json";
import itemNanopotion from "../sprites/item.json";
import itemBananopotion from "../sprites/item.json";
import itemRune from "../sprites/item.json";
import itemGemruby from "../sprites/item.json";
import itemGememerald from "../sprites/item.json";
import itemGemamethyst from "../sprites/item.json";
import itemGemtopaz from "../sprites/item.json";
import itemGemsapphire from "../sprites/item.json";
import itemGold from "../sprites/item.json";
...
import itemRaiblockstl from "../sprites/item.json";
import itemRaiblockstr from "../sprites/item.json";
import itemRaiblocksbl from "../sprites/item.json";
import itemRaiblocksbr from "../sprites/item.json";
import itemWirtleg from "../sprites/item.json";
import itemSkeletonkingcage from "../sprites/item.json";
import itemNecromancerheart from "../sprites/item.json";
import itemCowkinghorn from "../sprites/item.json";
import itemGoldenarmor from "../sprites/item.json";
import itemBluearmor from "../sprites/item.json";
import itemHornedarmor from "../sprites/item.json";
import itemFrozenarmor from "../sprites/item.json";
import itemDiamondarmor from "../sprites/item.json";
import itemSpikearmor from "../sprites/item.json";
import itemDemonarmor from "../sprites/item.json";
import itemBeltleather from "../sprites/item.json";
import itemBeltplated from "../sprites/item.json";
import itemBeltfrozen from "../sprites/item.json";
...
import itemShieldplate from "../sprites/item.json";
import itemShieldred from "../sprites/item.json";
import itemShieldgolden from "../sprites/item.json";
import itemShieldblue from "../sprites/item.json";
import itemShieldhorned from "../sprites/item.json";
import itemShieldfrozen from "../sprites/item.json";
import itemShielddiamond from "../sprites/item.json";
import itemShieldtemplar from "../sprites/item.json";
import itemShieldemerald from "../sprites/item.json";
import itemShieldexecutioner from "../sprites/item.json";
...
import itemExecutionersword from "../sprites/item.json";
import itemMysticalsword from "../sprites/item.json";
import itemDragonsword from "../sprites/item.json";
import itemLeatherarmor from "../sprites/item.json";
import itemMailarmor from "../sprites/item.json";
import itemMorningstar from "../sprites/item.json";
import itemPlatearmor from "../sprites/item.json";
import itemRedarmor from "../sprites/item.json";
import itemRedsword from "../sprites/item.json";
import itemDagger from "../sprites/item.json";
import itemSword from "../sprites/item.json";
...
const sprites = {
  ...
  "item-rune-mer": itemRune,
  "item-rune-qua": itemRune,
  "item-rune-gul": itemRune,
  ...
  "item-shieldemerald": itemShieldemerald,
  "item-shieldexecutioner": itemShieldexecutioner,
