...
var Items = {
  ...
  MoonSword: class MoonSword extends Item {
    constructor(id) {
      ...
      this.lootMessage = "You pick up a moon sword";
    }
  },
  ...
  DemonMaul: class DemonMaul extends Item {
    constructor(id) {
      super(id, Types.Entities.DEMONMAUL, "weapon");
      this.lootMessage = "You pick up a demon maul";
    }
  },
  ...
  HelmPaladin: class HelmPaladin extends Item {
    constructor(id) {
      super(id, Types.Entities.HELMPALADIN, "helm");
      this.lootMessage = "You pick up a paladin helm";
    }
  },
  ...
  PetEgg: class PetEgg extends Item {
    constructor(id) {
  ...
  PetDino: class PetDino extends Item {
    constructor(id) {
      super(id, Types.Entities.PETDINO, "object");
      this.lootMessage = "You pick up a Dino Pet";
    }
  },
  ...
  PetDuck: class PetDuck extends Item {
    constructor(id) {
      super(id, Types.Entities.PETDUCK, "object");
      this.lootMessage = "You pick up a Duck Pet";
    }
  },
  PetDeer: class PetDeer extends Item {
    constructor(id) {
  ...
  PetHellhound: class PetHellhound extends Item {
    constructor(id) {
      ...
      this.lootMessage = "You pick up a Hellhound Pet";
    }
  },
